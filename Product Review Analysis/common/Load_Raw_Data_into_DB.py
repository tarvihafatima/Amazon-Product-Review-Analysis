...
conf.set("spark.jars", "file:///D://spark-3.4.0-bin-hadoop3//spark-3.4.0-bin-hadoop3//bin//postgresql-42.6.0.jar")  # set the spark.jars
...
def load_reviews_dataset(conn, file_path):
    try:
        ...
        "url": "jdbc:postgresql://localhost:5432/amazonreviews",
        "user": "postgres",
        "password": "Minnie4321*"
        }
        ...
        json_df.write \
            ...
            .jdbc(db_properties["url"], "landing_db.reviews", mode="append", properties=db_properties)
...
def load_products_dataset(conn,file_path):
    try:
        ...
        json_df.write \
            .option("truncate", "true") \
            .jdbc(db_properties["url"], "landing_db.products", mode="append", properties=db_properties)
